      ...
      <div className="tenx-container">
        ...
        <div className="grid lg:grid-cols-5 gap-12">
          <div className="lg:col-span-2">
            <div className="bg-white shadow-sm p-8 rounded-lg border border-tenx-green/20">
          ...
          <div className="lg:col-span-3">
            <form onSubmit={handleSubmit} className="space-y-6 bg-white shadow-sm p-8 rounded-lg border border-tenx-green/20">
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    required
                    className="border-tenx-green/20 bg-white text-tenx-black focus:border-tenx-green"
                  />
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={handleChange}
                  required
                  className="min-h-[150px] border-tenx-green/20 bg-white text-tenx-black focus:border-tenx-green"
                />
              </div>
